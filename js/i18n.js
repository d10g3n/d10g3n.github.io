...
const translations = {
    en: {
        ...
        // Static Track Pages
        'track.backToHome': 'Back to Home',
        'track.album': 'Album',
        'track.isrc': 'ISRC',
        'track.listenOn': 'Listen on:',
        'track.lyrics': 'Lyrics',
        'track.watchOnYouTube': 'Watch on YouTube',
        'modal.lyrics': 'Lyrics',
        'modal.video': 'Video',
        'modal.close': 'Close',
    ...
    ru: {
        ...
        // Static Track Pages
        'track.backToHome': 'Вернуться на главную',
        'track.album': 'Альбом',
        'track.isrc': 'ISRC',
        'track.listenOn': 'Слушать на:',
        'track.lyrics': 'Текст песни',
        'track.watchOnYouTube': 'Смотреть на YouTube',
    ...
    uk: {
        ...
        // Static Track Pages
        'track.backToHome': 'Повернутися на головну',
        'track.album': 'Альбом',
        'track.isrc': 'ISRC',
        'track.listenOn': 'Слухати на:',
        'track.lyrics': 'Текст пісні',
        'track.watchOnYouTube': 'Дивитися на YouTube',
