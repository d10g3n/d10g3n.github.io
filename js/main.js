...
// Helper function to generate URL-friendly slug from track title
...
function createTrackItem(track) {
    ...
    item.innerHTML = `
        ...
        <div class="track-info">
            <a href="/track/${trackSlug}" class="track-title hoverable" data-track-id="${track.id}">${track.title}</a>
            <div class="track-meta">${album ? album.title : ''} • ${track.year}</div>
        </div>
        <div class="track-actions">
            <a href="/track/${trackSlug}" class="track-btn" aria-label="Info" title="View track details">
    ...
    // Info link - prevent default navigation and open modal instead (progressive enhancement)
    // const infoLink = item.querySelector('.track-actions .track-btn');
    // if (infoLink) {
    ...
    // Title link - prevent default navigation and open modal instead
